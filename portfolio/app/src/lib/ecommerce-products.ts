...
export const products: Product[] = [
  ...
  },
  {
    ...
    price: 320,
    category: 'kase',
    description: 'Derin ve geniş formlu, çorba ve tahıl kasesi.',
    material: 'Stoneware kil, mat sır',
    dimensions: '15cm çap, 10cm yükseklik',
    stock: 6,
    featured: false,
    color: '#c8b8a4',
  },
  {
    ...
    price: 480,
    category: 'vazo',
    description: 'Uzun ve zarif silindir formlu vazo.',
    material: 'Porselen, saten sır',
    dimensions: '8cm çap, 30cm yükseklik',
    stock: 3,
    featured: false,
    color: '#d0c4b4',
  },
  {
    id: 'kupa-003',
    name: 'Espresso Kupası',
    price: 160,
    category: 'kupa',
    description: 'Küçük ve şık espresso kupası, çift set.',
    material: 'Porselen, parlak sır',
    dimensions: '6cm çap, 6cm yükseklik',
    stock: 12,
    featured: false,
    color: '#c4b8a8',
  },
  {
    id: 'dekor-003',
    name: 'Tuzluk & Biberlik',
    price: 340,
    category: 'dekor',
    description: 'El yapımı eşleşen tuzluk ve biberlik seti.',
    material: 'Şamot kil, doğal sır',
    dimensions: '5cm çap, 8cm yükseklik',
    stock: 5,
    featured: false,
    color: '#d4c8b8',
  },
